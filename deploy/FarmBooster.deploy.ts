...
const deployFarmBooster: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  await deploy('FarmBooster', {
    from: deployer,
    args: [PLATFORM_TOKEN_ADDRESS, CAKE_POOL_ADDRESS, MASTER_CHEF_V2_ADDRESS, MAX_BOOST_POOL, 50000, 5],
    log: true,
